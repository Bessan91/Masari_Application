...
public class myListBookingAdapter extends RecyclerView.Adapter<myListBookingAdapter.ViewHolder> {
    ArrayList<tours> listBooking;

    public myListBookingAdapter(ArrayList<tours> listBooking) {
        this.listBooking = listBooking;
    }

    @Override
    public myListBookingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        /////////////////
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_suggested, parent, false);
        return new myListBookingAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull myListBookingAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
